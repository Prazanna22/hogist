...
export const Home = () => {
    ...
    return (
        <>
            <div className=" ">
                <div className='grid grid-coln-1 md:grid-cols-2 md:py-14'>
                    <div className=' py-10  md:py-28 bg-white md:pl-10 lg:pl-20 flex items-center text-center md:items-start flex-col md:text-left'>
                        <h1 className='my-5 font-medium text-lg'>Organic food</h1>
                        <p className="font-bold text-6xl my-5">Testy & Healthy Organic Food</p>
                        <p className='font-normal my-5 text-md'>Deliciously nutritious, our organic food brings you the perfect balance of taste and health.</p>
                        <button className='py-4 px-4 flex my-5 bg-red-500 text-white font-bold rounded-lg'>Explore products </button>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  bg-black text-white py-20 px-10">
                    <div className="md:flex hidden ">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 bg-gradient-to-br from-yellow-500 to-white p-5 rounded-2xl ">
                        <div className="text-black order-2 md:order-1">
                            ...
                            <button className='py-3 px-6 flex my-5 bg-yellow-400 text-white font-bold rounded-lg'>Shop Now</button>
                        </div>
                ...
                <ProductCategories />
                <div className=" px-20 bg-black py-20 pb-30">
                    <h1 className='text-center font-bold text-2xl md:text-6xl mb-12 my-10 md:mx-72 text-white '>Wholesome Dairy Delights Delivered Fresh to You</h1>
                    <div className="grid md:grid-cols-4 grid-cols-1 sm:grid-cols-2 gap-10">
                        <div className="flex flex-col justify-center items-center py-10 px-5 bg-black text-white rounded-2xl border border-white">
                        ...
                        <div className="flex flex-col justify-center items-center py-10 px-5 bg-black text-white rounded-2xl border border-white">
                            <img src={delivery} alt="" className="w-14 h-14 bg-green-400 p-2 rounded-full mb-4" />
                            <p className='font-semibold text-center text-xl'>30-Day, No-Risk Money-Back Assurance</p>
                        </div>
                        <div className="flex flex-col justify-center items-center py-10 px-5 bg-black text-white rounded-2xl border border-white">
                            <img src={delivery} alt="" className="w-14 h-14 bg-green-400 p-2 rounded-full mb-4" />
                            <p className='font-semibold text-center text-xl'>24/7 Expert Help, Always Just a Click Away</p>
                        </div>
                        <div className="flex flex-col justify-center items-center py-10 px-5 bg-black text-white rounded-2xl border border-white">
                            <img src={delivery} alt="" className="w-14 h-14 bg-green-400 p-2 rounded-full mb-4" />
                            <p className='font-semibold text-center text-xl'>Flexible Payments with Various Credit Card Options</p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col items-center bg-black" >
                    ...
                    <form ref={form} onSubmit={sendEmail} className="flex flex-col my-10 md:my-20 ">
                        ...
                        <button type="submit" value="Send" className="bg-white font-semibold text-center py-2" >Subscribe</button>
                    </form>
                </div>
                <Footer />
            </div>
