    ...
    return (
        <>
            <div className=" px-10 md:px-20 bg-[#000]  text-white">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 text-sm font-medium text-left sm:text-left">
                    ...
                    <div className="py-5 px-3">
                        <p className='mt-5 mb-2 cursor-pointer'>Address :</p>
                        <p className='my-0 cursor-pointer'>327 Park Ave S, New York, NY 10010 United States</p>
                        <p className='mt-5 mb-2 cursor-pointer'>Hours :</p>
                        <p className='my-0 cursor-pointer'>Mon-Fri: 9 AM to 5 PM</p>         
                        <p className='mt-5 mb-2 cursor-pointer'>Phone :</p>
                        <p className='my-0 cursor-pointer'>+1 877 217 8371</p>
                    </div>
                </div>
